...
default_user="maxscale"
default_passwd="mariadb"
db_image="mariadb:11.8.2"
root_passwd="mariadb"
...
def generate_files(config, maxscale_params, systest_params):
    ...
    for server in servers:
        ...
        volumes:
            - %s
        command: mariadbd --log-bin=binlog --binlog-format=ROW --server-id=%d --port=%d --log-slave-updates --wait_timeout=28800 --net_read_timeout=28800 --net_write_timeout=28800 --interactive_timeout=28800\n'''
